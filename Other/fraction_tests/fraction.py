...
class Fraction:
    ...
    def __mul__(self, other):
        try:
            if isinstance(other, Fraction):
                result = self.reduction(self.num * other.num, self.den * other.den)
    ...
    def __truediv__(self, other):
        try:
            if isinstance(other, Fraction):
                result = self.reduction(self.num * other.den, self.den * other.num)
                return Fraction(result[0], result[1])
            else:
                raise FractionError
        except FractionError:
    ...
    def __add__(self, other):
        try:
            if isinstance(other, Fraction):
                ...
                other_num_index = int(denomimator / other.den)
